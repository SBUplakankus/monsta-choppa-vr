namespace Constants
{
    public class AudioKeys
    {
        ...
        public const string MixerMusicA =  "MusicA";
        public const string MixerMusicB =  "MusicB";
        
        public const string MainMusic = "mainmusic";
        public const string MainSfx = "sfx";
        public const string MainAmbience = "mainambience";
